        ...
        switch (event.code) {
            case "KeyA":
                if (event.getModifierState("Shift")) {
                    ...
                    if (state.hasSelected) {
                        ...
                        vec3.add(object.centroid, object.centroid, vec3.fromValues(0.1, 0.0, 0.0));
                    } else {
                        vec3.add(state.camera.center, state.camera.center, vec3.fromValues(0.1, 0.0, 0.0));
            ...
            case "KeyW":
                if (event.getModifierState("Shift")) {
                    ...
                    if (state.hasSelected) {
                        ...
                        vec3.add(object.centroid, object.centroid, vec3.fromValues(0.0, 0.0, -0.1));
                    } else {
            ...
            case "Space":
                ...
                if (!state.hasSelected) {
                    ...
                    scaleVertices(object.verticesList, 1.2);
                    object.centroid = calculateCentroid(object.verticesList, vec3.fromValues(0.0, 0.0, 0.5));

                } else {
                    state.hasSelected = false;
                    document.getElementById("selectionText").innerHTML = "Selection: None";
                    vec3.scale(object.model.scale, object.model.scale, 0.85);
                    scaleVertices(object.verticesList, 0.85);
                    object.centroid = calculateCentroid(object.verticesList, vec3.fromValues(0.0, 0.0, 0.5));
                }
...
function rotateObjectY(object, val) {
...
function rotateObjectX(object, val) {
    let negativeCentroid = vec3.create();
    vec3.negate(negativeCentroid, object.centroid);
    vec3.add(object.model.position, object.model.position, negativeCentroid);
...
function rotateObjectZ(object, val) {
    let negativeCentroid = vec3.create();
    vec3.negate(negativeCentroid, object.centroid);
    vec3.add(object.model.position, object.model.position, negativeCentroid);
